...
window.addEventListener('load',async(e)=>{
    ...
    form.full_name.setAttribute('value',user_data.user[0].full_name)
    form.username.setAttribute('value',user_data.user[0].username)
    form.email.setAttribute('value',user_data.user[0].email)
    form.level.setAttribute('value',user_data.user[0].level_id)
